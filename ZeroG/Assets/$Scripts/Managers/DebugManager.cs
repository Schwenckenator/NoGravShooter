...
static class DebugManager {
    ...
    public static bool allWeapon { get; set; }
    public static bool allAmmo { get; set; }
    public static bool allGrenade { get; set; }
    public static bool allFuel { get; set; }
    public static bool paintballMode { get; set; }
